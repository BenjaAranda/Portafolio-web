...
4. Completar Configuración y Perfil; crear capacidades, educación, proyectos y certificados reales.
...
5. Configurar dominio canónico en `SITE_URL`.
...
Vercel Hobby queda sujeto a sus condiciones personales/no comerciales y cuotas actuales. No se han creado cuentas, conectado repositorios ni publicado servicios desde esta implementación local.
